...
import com.adprojects.hotel_lakeSide.exceptions.PhotoRetrievalException;
...
import com.adprojects.hotel_lakeSide.services.BookingService;
...
public class RoomController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<RoomResponse> updateRoomResponse(@PathVariable Long roomId,
